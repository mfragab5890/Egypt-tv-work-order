...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <h2 class="txt text-center">اضافة مرفقات</h2>
            <br><hr>
            <form id="att-form" method="post" enctype="multipart/form-data" class="txt form-horizontal" >
                <div class="form-group">
                    <label class="control-label col-sm-2" for="ord-type" required>نوع الخطاب </label>
                    <div class="col-sm-10">
                        <select class="form-control" id="ord-type" required>
                            <option disabled selected value=""> -- برجاء الاختيار اولا -- </option>
                            <option>خطاب صادر</option>
                            <option>خطاب وارد</option>
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="req-id">الرقم المسلسل للخطاب</label>
                    <div class="col-sm-10">
                        <select class="form-control" id="req-id" required>
                            <option disabled selected value=""> -- برجاء الاختيار اولا -- </option>
                            <option>.....</option>
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="new-att">المرفقات</label>
                    <div class="col-sm-10">
                        <input type="file" class="form-control-file" id="new-att" name="image[]" multiple="" required>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="att-name">اسم الصورة</label>
                    <div class="col-sm-10">
                        <input class="form-control-file" id="att-name" name="اسم الصورة" required>
                    </div>
                </div>
               
                <div class="form-group">        
                    <div class="col-sm-offset-2 col-sm-10">
                        <button type="button" class="btn btn-primary" id="natsub">اضافة</button>
                    </div>
                </div>
            </form>
        </div>
