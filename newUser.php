<?php
    ...
    //query entities
    $queryuse=" SELECT `id`, `email` FROM `users`" ;	
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <h2 class="txt text-center">اضافة مسؤول تسجيل جديد</h2>
            <br><hr>
            <h3 class="txt text-center">الاسماء المسجلة الحالية</h3>
            <div class="bg-wyt">
                <table id="dtDynamicVerticalScrollExample" class="table table-striped table-bordered table-dark table-sm" cellspacing="0" >
                    <thead>
                        <tr>
                            <th class="th-sm">#</th>
                            <th class="th-sm">اسم المسجل</th>
            ...
            <br>
            <form id="user-form" method="post" class="txt form-horizontal" >
                
                <div class="form-group">
                    <label class="control-label col-sm-2" for="new-res">اسم المسجل الجديد</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="new-res" placeholder="مسجل جديد" name="res" required>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="password">برجاء اختيار كلمة سر</label>
                    <div class="col-sm-10">
                        <input type="password" placeholder="كلمة السر" id="password" required>
                        <input type="password" placeholder="تاكيد كلمة السر" id="confirm_password" required>
                    </div>
                ...
                <div class="form-group">        
                    <div class="col-sm-offset-2 col-sm-10">
                        <button type="button" class="btn btn-primary" id="nressub">اضافة</button>
                    </div>
                </div>
            </form>
        </div>
