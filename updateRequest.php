<?php
  ...
  include("connection.php");
    ...
    $user = "ghelpo";
    $user_id = 1;
    $queryrec=" SELECT `id`, `num`, `subject`, `status` FROM `recvorder`" ;	
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <br><hr>
            <form id="req-form" method="post" enctype="multipart/form-data" class="txt form-horizontal" >
                
                <div class="form-group">
                    <label class="control-label col-sm-2" for="reqr-id-up">الرقم المسلسل للخطاب و الموضوع</label>
                    <div class="col-sm-10">
                        <select class="form-control" id="reqr-id-up" required>
               ...
               <div class="form-group">
                    <label class="control-label col-sm-2" for="cur-rstat">الحالة السابقة</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="cur-rstat" placeholder="الحالة الحالية" name="res" value="" readonly>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="nrstat">الحالة الحالية</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nrstat" placeholder="الحالة الحالية" name="">
                    </div>
                </div>
               
                <div class="form-group">        
                    <div class="col-sm-offset-2 col-sm-10">
                        <button type="button" class="btn btn-primary" id="up-rstat">تحديث</button>
                    </div>
                </div>
            </form>
        </div>
